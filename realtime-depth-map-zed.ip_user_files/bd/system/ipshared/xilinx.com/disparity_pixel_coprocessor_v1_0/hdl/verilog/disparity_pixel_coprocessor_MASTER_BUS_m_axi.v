...
module disparity_pixel_coprocessor_MASTER_BUS_m_axi
#(parameter
    C_M_AXI_ID_WIDTH        = 1,
...
disparity_pixel_coprocessor_MASTER_BUS_m_axi_throttl #(
    .USED_FIX(0)
) wreq_throttl (
    .clk(ACLK),
    .reset(ARESET),
...
// disparity_pixel_coprocessor_MASTER_BUS_m_axi_write
disparity_pixel_coprocessor_MASTER_BUS_m_axi_write #(
...
// disparity_pixel_coprocessor_MASTER_BUS_m_axi_read
disparity_pixel_coprocessor_MASTER_BUS_m_axi_read #(
    .C_M_AXI_ID_WIDTH        ( C_M_AXI_ID_WIDTH ),
    .C_M_AXI_ADDR_WIDTH      ( C_M_AXI_ADDR_WIDTH ),
    .C_TARGET_ADDR     ( C_TARGET_ADDR ),
...
module disparity_pixel_coprocessor_MASTER_BUS_m_axi_fifo
#(parameter
    DATA_BITS  = 8,
    DEPTH      = 16,
    DEPTH_BITS = 4
...
module disparity_pixel_coprocessor_MASTER_BUS_m_axi_decoder
#(parameter
    DIN_WIDTH       = 3
)(
...
module disparity_pixel_coprocessor_MASTER_BUS_m_axi_throttl
#(parameter
    USED_FIX       = 0,
    FIX_VALUE      = 4
)(
...
module disparity_pixel_coprocessor_MASTER_BUS_m_axi_read
#(parameter
    C_M_AXI_ID_WIDTH        = 1,
    C_M_AXI_ADDR_WIDTH      = 32,
    C_TARGET_ADDR     = 32'h00000000,
...
//------------------------AR channel begin---------------
//------------------------Instantiation------------------
    disparity_pixel_coprocessor_MASTER_BUS_m_axi_fifo #(
...
module disparity_pixel_coprocessor_MASTER_BUS_m_axi_write
#(parameter
    C_M_AXI_ID_WIDTH        = 1,
    C_M_AXI_ADDR_WIDTH      = 32,
    C_TARGET_ADDR     = 32'h00000000,
...
//------------------------Body---------------------------
    ...
    if (USER_DATA_WIDTH == BUS_DATA_WIDTH) begin : bus_equal_gen
        ...
        disparity_pixel_coprocessor_MASTER_BUS_m_axi_decoder #(
            .DIN_WIDTH(PAD_ALIGN)
        ) head_pad_decoder (
            .din(head_pads),
            .dout(head_pad_sel));
