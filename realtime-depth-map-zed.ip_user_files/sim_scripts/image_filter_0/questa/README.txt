...
#
# Generated by export_simulation on Sun Mar 05 10:54:06 CET 2017
#
################################################################################
...
switch to the './image_filter_0.sh' script.

./image_filter_0.sh -reset_run
...
./image_filter_0.sh -noclean_files

For more information on the script, please type './image_filter_0.sh -help'.
