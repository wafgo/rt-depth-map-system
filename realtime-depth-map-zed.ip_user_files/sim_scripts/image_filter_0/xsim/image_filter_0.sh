...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb image_filter_0.wdb xsim.dir)
...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto 77e97b073e86477c8a1e7ccde69ef14e -m64 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot image_filter_0 xil_defaultlib.image_filter_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim image_filter_0 -key {Behavioral:sim_1:Functional:image_filter_0} -tclbatch cmd.tcl -log simulate.log
}
# Script usage
usage()
{
