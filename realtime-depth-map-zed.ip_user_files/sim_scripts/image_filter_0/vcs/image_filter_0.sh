...
reset_run()
{
  files_to_remove=(ucli.key image_filter_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc image_filter_0_simv.daidir)
...
compile()
{
  ...
  vlogan -work xil_defaultlib $opts_ver +v2k +incdir+"$ref_dir/../../../../adv7511_zed.srcs/sources_1/ip/image_filter_0/drivers/image_filter_v1_0/src" \
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.image_filter_0 xil_defaultlib.glbl -o image_filter_0_simv
}
...
simulate()
{
  ...
  ./image_filter_0_simv $opts -do simulate.do
}
# Script usage
usage()
{
